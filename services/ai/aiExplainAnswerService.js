...
exports.generateAnswerExplanation = async ({
  question,
  options,
  correctanswer,
  useranswer
...
exports.generateAnswerExplanation1 = async ({
  question,
  options,
  correctanswer,
  useranswer
 ...
 */
exports.generateAnswerExplanation2 = async ({ question, options, correctanswer, useranswer }) => {
